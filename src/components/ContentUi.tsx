  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <Link to={`/post/${post.id}`} state={{ post }} className="mb-4 block flex-1">
          <h3 className="text-lg md:text-xl font-black text-gray-900 group-hover:text-blue-600 transition leading-[1.3] uppercase tracking-tight">
            {post.title}
          </h3>
        </Link>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-50">
          ...
          <Link
            to={`/post/${post.id}`}
            state={{ post }}
            className="flex items-center justify-center gap-2 bg-[#1877F2] text-white px-8 py-3 rounded-xl font-black text-[10px] transition-all shadow-lg shadow-blue-200 group-hover:bg-[#115cc1] active:scale-95 uppercase tracking-widest"
          >
            Open
